...
\begin{supplements}[
  ...
  \supplement[
      tocentry={The beamerthemeusafa.edu package},
  ]{beamerthemeusafa.edu.pdf}{The \textsf{beamerthemeusafa.edu} package}
\end{supplements}
...
\begin{supplements}[
  ...
  ]{promotion.pdf}{The \textsf{promotion} package}
  \supplement[
      tocentry={The record package},
  ]{record.pdf}{The \textsf{record} package}
  \supplement[
      tocentry={The statement package},
  ]{statement.pdf}{The \textsf{statement} package}
  \supplement[
      tocentry={The supplements package},
  ]{supplements.pdf}{The \textsf{supplements} package}
\end{supplements}
